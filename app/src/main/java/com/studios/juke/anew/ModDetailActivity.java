...
public class ModDetailActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      arguments.putString(ModDetailFragment.ARG_ITEM_ID,
          getIntent().getStringExtra(ModDetailFragment.ARG_ITEM_ID));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == android.R.id.home) {
      ...
      //
      navigateUpTo(new Intent(this, ModListActivity.class));
      return true;
    }
